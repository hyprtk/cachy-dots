...
echo ""
sudo cp ~/cachy-dots/sddm/sddm.conf /etc/sddm.conf.d/
echo "File /etc/sddm.conf.d/sddm.conf updated."
echo ""
cp ~/cachy-dots/default.png ~/.cache/current-wallpaper.png
echo ""
...
echo ""
echo ""
sudo cp ~/cachy-dots/sddm/theme.conf /usr/share/sddm/themes/Sugar-Candy/
