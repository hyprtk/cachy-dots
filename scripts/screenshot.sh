...
SAVE_DIR=$(cat ~/cachy-dots/scripts/settings/screenshot-folder)
SAVE_FILENAME=$(cat ~/cachy-dots/scripts/settings/screenshot-filename)
eval screenshot_folder="$SAVE_DIR"
eval NAME="$SAVE_FILENAME"

# Notifications
source "$HOME/cachy-dots/scripts/notification-handler"
APP_NAME="Screen Capture"
NOTIFICATION_ICON="camera-photo-symbolic"

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat $HOME/cachy-dots/scripts/settings/screenshot-editor)"
